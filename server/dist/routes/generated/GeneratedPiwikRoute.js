...
const GeneratedPiwikRoute = (config) => {
    return express_1.Router().get('/generated/piwik.js', (req, res) => {
        let response = '';
...
exports.default = GeneratedPiwikRoute;
//# sourceMappingURL=GeneratedPiwikRoute.js.map