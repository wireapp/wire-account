...
const AppleAssociationRoute = (config) => express_1.Router().get('/apple-app-site-association', (req, res) => {
    const response = `
    {
      "webcredentials": {
        "apps": [
...
exports.default = AppleAssociationRoute;
//# sourceMappingURL=GeneratedAppleRoute.js.map